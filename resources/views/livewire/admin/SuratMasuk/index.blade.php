<div class="max-w-7xl mx-auto" wire:poll.visible>
    <!-- Page Title Row -->
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
        ...
        <!-- Loading -->
        <div wire:loading.delay class="px-6 py-3 text-sm text-primary font-medium flex items-center gap-2">
                        ...
                        <th class="text-left px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wide">
                            <div class="flex items-center gap-2 cursor-pointer group" wire:click="toggleSort">
                                ...
                                <div class="flex flex-col">
                                    <svg id="sort-asc" class="w-3 h-3 -mb-1 {{ $sortOrder === 'asc' ? 'text-primary' : 'text-gray-400' }} group-hover:text-gray-600 transition-colors" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M10 5l4 5H6l4-5z"/>
                                    </svg>
                                    <svg id="sort-desc" class="w-3 h-3 {{ $sortOrder === 'desc' ? 'text-primary' : 'text-gray-400' }} group-hover:text-gray-600 transition-colors" fill="currentColor" viewBox="0 0 20 20">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($suratMasuk as $i => $surat)
                        <tr class="hover:bg-gray-100 transition-colors">
                            ...
                            <td class="px-6 py-3.5 text-gray-600 text-sm whitespace-nowrap">{{ $surat->tanggal_diterima?->format('d/m/Y') ?? '-' }}</td>
