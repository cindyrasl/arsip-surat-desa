    ...
    <div class="flex items-center gap-3 mb-5 fade-up">
        ...
        <div>
            ...
            <p class="text-xs text-gray-500">
                {{ $isEdit ? 'Edit arsip surat masuk' : 'Tambah arsip surat masuk baru' }}
            </p>
        </div>
    </div>
        ...
        <form wire:submit.prevent="save" class="p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" wire:model="asal" 
                           class="w-full px-4 py-2.5 text-sm border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all @error('asal') border-red-500 @enderror" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="date" wire:model="tanggal_terima"
                           class="w-full px-4 py-2.5 text-sm border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all @error('tanggal_terima') border-red-500 @enderror">
